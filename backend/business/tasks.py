...
from config.settings import YOOKASSA_RETURN_URL, YOOKASSA_ACCOUNT_ID, YOOKASSA_SECRET_KEY
...
def payment_create_task(self,
                        amount: Decimal,
                        payment_method: PaymentMethod,
                        description: str,
                        return_url: str = YOOKASSA_RETURN_URL,
                        receipt: dict | None = None,
                        metadata: dict | None = None) -> PaymentResponse:
    try:
